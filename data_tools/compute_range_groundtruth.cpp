...
int main(int argc, char *argv[]) {
    ...
    if (tp == "float") {
        ...
        if (df == "Euclidian") {
            ...
            answers =
                compute_range_groundtruth<PointRange<float, Euclidian_Point<float>>>(
                    B, Q, r);
        } else if (df == "mips") {
            ...
            answers = compute_range_groundtruth<PointRange<float, Mips_Point<float>>>(
                          B, Q, r);
        }
    } else if (tp == "uint8") {
        ...
        if (df == "Euclidian") {
            ...
            answers =
                compute_range_groundtruth<PointRange<uint8_t, Mips_Point<uint8_t>>>(
                    B, Q, r);
        }
    } else if (tp == "int8") {
        ...
        if (df == "Euclidian") {
            ...
            answers =
                compute_range_groundtruth<PointRange<int8_t, Mips_Point<int8_t>>>(
                    B, Q, r);
        }
    }
