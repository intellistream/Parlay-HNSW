...
int main(int argc, char* argv[]) {
    ...
    if (tp == "float") {
        ...
        if (df == "Euclidian") {
            ...
            answers =
                compute_groundtruth<PointRange<Euclidian_Point<float>>>(B, Q, k);
        } else if (df == "mips") {
        ...
        if (df == "Euclidian") {
            ...
            answers =
                compute_groundtruth<PointRange<Euclidian_Point<uint8_t>>>(B, Q, k);
        } else if (df == "mips") {
        ...
        if (df == "Euclidian") {
            ...
            answers =
                compute_groundtruth<PointRange<Euclidian_Point<int8_t>>>(B, Q, k);
        } else if (df == "mips") {
